...
export const updateReducer = createReducer(
  {},
  {
    ...
    ADD_PLATFORM_REQUEST: (state) => {
      state.loading = true;
    },
    ADD_PLATFORM_SUCCESS: (state, action) => {
      state.loading = false;
      state.message = action.payload;
    },
    ADD_PLATFORM_FAILURE: (state, action) => {
      state.loading = false;
      state.error = action.payload;
    },

    DELETE_PLATFORM_REQUEST: (state) => {
      state.loading = true;
    },
    ...
    DELETE_PLATFORM_FAILURE: (state, action) => {
      state.loading = false;
      state.error = action.payload;
    },
